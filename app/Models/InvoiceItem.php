...
class InvoiceItem extends Model
{
    ...
    public function hoarding(): BelongsTo { return $this->belongsTo(Hoarding::class); }

    public function getFormattedRate(): string        { return '₹' . number_format($this->rate, 2); }
    public function getFormattedAmount(): string      { return '₹' . number_format($this->amount, 2); }
    public function getFormattedTaxableAmount(): string { return '₹' . number_format($this->taxable_amount, 2); }
    public function getFormattedTotalTax(): string    { return '₹' . number_format($this->total_tax, 2); }
    public function getFormattedTotalAmount(): string { return '₹' . number_format($this->total_amount, 2); }
