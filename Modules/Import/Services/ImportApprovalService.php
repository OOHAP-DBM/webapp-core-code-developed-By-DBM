...
class ImportApprovalService
{
    ...
    protected function processRow(InventoryImportBatch $batch, InventoryImportStaging $stagingRow): void
    {
        ...
        $hoarding = Hoarding::create([
            ...
            'base_monthly_price' => $this->stagingValue($stagingRow, 'base_monthly_price', 0),
    ...
    protected function createDOOHRecords(Hoarding $hoarding, InventoryImportStaging $stagingRow): void
    {
        try {
            ...
            $doohScreen = DOOHScreen::create([
                ...
                'min_slots_per_day' => $this->stagingValue($stagingRow, 'min_slots_per_day', null),
                'minimum_booking_amount' => $this->stagingValue($stagingRow, 'minimum_booking_amount', null),
                'commission_percent' => $this->stagingValue($stagingRow, 'commission_percent', null),
