...
// Customer routes (Coming soon - using BookingHoldController for now)
...
Route::post('/webhook/razorpay', [\Modules\Payment\Controllers\Api\RazorpayWebhookController::class, 'handle']);

// Admin routes (Coming soon - using FinanceController for now)
