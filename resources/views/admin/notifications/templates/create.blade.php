    ...
    <div class="row justify-content-center">
        <div class="col-lg-10">
            ...
            <div class="mb-4">
                ...
                <h2 class="mb-1">Create Notification Template</h2>
                <p class="text-muted mb-0">Create a new template for automated notifications</p>
            </div>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="card border-0 shadow-sm">
                            ...
                            <div class="card-body">
                                <div id="placeholders_list" class="text-muted small">
                                    <em>Select an event type to see available placeholders</em>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card border-0 shadow-sm">
                    <div class="card-body">
                        <div class="d-flex justify-content-end gap-2">
                            <a href="{{ route('admin.notifications.templates.index') }}" class="btn btn-outline-secondary">
...
document.getElementById('event_type').addEventListener('change', function() {
    ...
    if (eventType && eventPlaceholders[eventType]) {
        ...
        placeholdersList.innerHTML = '<em class="text-muted">Select an event type</em>';
    }
});
