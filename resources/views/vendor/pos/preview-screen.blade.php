       ...
       <div class="w-full lg:w-[35%]">
            <div class="bg-white rounded-md shadow-xl border border-gray-200 p-3 sm:p-4 lg:p-6 lg:sticky lg:top-6 space-y-5">
                ...
                <div class="pt-4 border-t border-dashed space-y-3">
                    <div class="flex justify-between text-sm font-bold "><span>Subtotal</span><span id="side-sub-total">₹0</span></div>
                    <div class="flex justify-between text-sm text-red-500"><span>Discount</span><span id="side-discount-display">-₹0</span></div>
                    <div class="flex justify-between text-sm text-gray-500 font-bold"><span>Taxes ( 18%)</span><span id="side-tax">₹0</span></div>
