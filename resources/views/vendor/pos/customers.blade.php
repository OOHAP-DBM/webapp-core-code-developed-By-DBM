            ...
            <table class="w-full min-w-[920px] divide-y divide-gray-200 text-xs sm:text-sm">
                <thead class="bg-gray-50 sticky top-0 z-10">
                    <tr class="text-left text-gray-600 uppercase text-xs tracking-wider">
                        ...
                        <th class="px-2 sm:px-3 md:px-4 py-2 sm:py-3">Contact</th>
                        <th class="px-2 sm:px-3 md:px-4 py-2 sm:py-3 text-center">Bookings</th>
                        <th class="px-2 sm:px-3 md:px-4 py-2 sm:py-3 text-right">Total Spent</th>
                        <th class="px-2 sm:px-3 md:px-4 py-2 sm:py-3">Last Booking</th>
