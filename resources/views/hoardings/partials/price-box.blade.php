        ...
        <div class="flex-1">
            ...
            <div class="flex gap-4 mt-4">
                ...
                <a href="https://mail.google.com/mail/?view=cm&fs=1&to={{ $hoarding->vendor->email }}"
                    target="_blank"
                    class="flex items-center gap-2 px-5 py-1 rounded-xl bg-orange-200 text-orange-800 font-medium hover:bg-orange-300 transition">
                     ...
                     <a href="tel:{{ $hoarding->vendor->vendorProfile->phone ?? $hoarding->vendor->phone }}"
                           class="flex items-center gap-2 px-5 py-1 rounded-xl bg-blue-300 text-blue-900 font-medium">
            ...
            <div class="mt-6">
                <a href="{{ route('vendors.show', $hoarding->vendor->id) }}"
                   class="flex items-center text-green-600 font-semibold hover:underline">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 ml-2" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
