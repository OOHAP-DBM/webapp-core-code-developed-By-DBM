    ...
    <div class="bg-[#f5f5f5] w-full max-w-lg rounded-2xl shadow-xl relative px-10 py-8">
        ...
        <div class="flex justify-center gap-6 mb-8">
            <div>
                ...
                <input type="number" x-model.number="to" class="w-28 text-center border rounded-md px-3 py-2" placeholder="Commission %">
            </div>
        </div>
