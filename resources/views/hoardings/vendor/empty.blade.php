...
<div class="flex flex-col items-center justify-center min-h-[60vh] px-4">
    ...
    <div class="w-full max-w-2xl p-8 md:p-16 bg-white rounded-xl shadow-sm border border-gray-100 flex flex-col items-center justify-center">
        ...
        <a href="{{ route('vendor.hoardings.add') }}" 
           class="inline-flex items-center justify-center px-8 py-3 btn-color hover:bg-[#319795] text-white font-medium rounded-lg transition-all duration-200 transform active:scale-95 shadow-md">
