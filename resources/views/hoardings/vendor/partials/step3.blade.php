    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div class="space-y-2">
            ...
            <div class="relative">
                ...
                <input type="number" name="display_price_per_30s" placeholder="Enter Price" required class="w-full border border-gray-200 rounded-xl pl-8 pr-20 py-3.5 focus:border-[#009A5C] outline-none transition-all">
...
<div class="bg-white rounded-[2rem] p-8 shadow-sm border border-gray-100 mt-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-end">
        ...
        <div class="flex items-center gap-3 p-4">
            <input type="checkbox" name="has_offer_discount" class="w-5 h-5 rounded border-gray-300 text-[#009A5C] cursor-pointer">
