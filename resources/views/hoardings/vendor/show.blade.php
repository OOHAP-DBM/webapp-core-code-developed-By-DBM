...
<div class="hoarding-wrapper">
    ...
    <div class="mb-6 border-gray-200 flex items-center justify-between">
        <ul class="flex -mb-px text-sm" id="hoardingTabs">
            <li>
                <button class="tab-btn px-4 py-2 border-b-2 font-semibold text-gray-700 border-transparent hover:text-green-600 hover:border-green-600 focus:outline-none"
                    data-tab="general" id="tabGeneralBtn">General</button>
            </li>
            <li>
                <button class="tab-btn px-4 py-2 border-b-2 font-semibold text-gray-700 border-transparent hover:text-green-600 hover:border-green-600 focus:outline-none"
                    data-tab="review" id="tabReviewBtn">Review</button>
            </li>
        </ul>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        // Page load pe hash check karo
        const hash = window.location.hash.replace('#', '');
        activateTab(hash === 'review' ? 'review' : 'general');
    });
</script>
@endpush
@endsection