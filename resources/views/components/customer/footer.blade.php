        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-10">
            ...
            <div>
                ...
                <div class="flex space-x-3">
                    <a href="https://www.facebook.com/profile.php?id=100083678822547" target="_blank" class="w-9 h-9 bg-white border border-gray-300 rounded flex items-center justify-center hover:bg-gray-100 transition-colors" title="Facebook">
                    ...
                    <a href="https://www.instagram.com/oohappofficial/" target="_blank" class="w-9 h-9 bg-white border border-gray-300 rounded flex items-center justify-center hover:bg-gray-100 transition-colors" title="Instagram">
                        <svg class="w-4 h-4 text-gray-700" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="https://twitter.com/oohapads" target="_blank"  class="w-9 h-9 bg-white border border-gray-300 rounded flex items-center justify-center hover:bg-gray-100 transition-colors" title="Twitter/X">
                        <svg class="w-4 h-4 text-gray-700" fill="currentColor" viewBox="0 0 24 24">
                            <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
                        </svg>
                    </a>
                    <a href="https://www.linkedin.com/company/oohapp/" target="_blank" class="w-9 h-9 bg-white border border-gray-300 rounded flex items-center justify-center hover:bg-gray-100 transition-colors" title="LinkedIn">
                        <svg class="w-4 h-4 text-gray-700" fill="currentColor" viewBox="0 0 24 24">
