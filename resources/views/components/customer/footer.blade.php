        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-10">
            ...
            <div>
                ...
                <div class="flex space-x-3">
                    <a href="https://facebook.com/oohapp" target="_blank" class="w-9 h-9 bg-white border border-gray-300 rounded flex items-center justify-center hover:bg-gray-100 transition-colors" title="Facebook">
                    ...
                    <a href="https://www.instagram.com/oohapp" target="_blank" class="w-9 h-9 bg-white border border-gray-300 rounded flex items-center justify-center hover:bg-gray-100 transition-colors" title="Instagram">
                        <svg class="w-4 h-4 text-gray-700" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="https://twitter.com/oohapp" target="_blank"  class="w-9 h-9 bg-white border border-gray-300 rounded flex items-center justify-center hover:bg-gray-100 transition-colors" title="Twitter/X">
                        <svg class="w-4 h-4 text-gray-700" fill="currentColor" viewBox="0 0 24 24">
