...
<div class="py-4 px-2 sm:px-4 md:px-6 lg:px-8 w-full max-w-8xl mx-auto">
    ...
    <form id="edit-form" action="{{ route('admin.dooh.update', $screen->id) }}" method="POST" enctype="multipart/form-data" class="space-y-6 px-1 sm:px-0">
        @csrf
        @method('PUT')
        ...
        <div class="flex flex-col sm:flex-row justify-between gap-2 sm:gap-3 mb-8 max-w-8xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex gap-2">
                ...
                @else
                    <a href="{{ route('admin.dooh.edit', ['id' => $screen->id, 'step' => $step - 1]) }}"
                        id="prevLink"
