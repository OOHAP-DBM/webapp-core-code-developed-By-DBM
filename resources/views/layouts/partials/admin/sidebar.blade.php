...
<aside class="w-64 bg-gray-900 text-white overflow-y-auto">
    ...
    <nav class="px-4 pb-4">
        <div class="space-y-1">
            ...
            <a href="{{ route('admin.kyc.index') }}" class="flex items-center px-3 py-2 text-sm font-medium rounded-lg {{ request()->routeIs('admin.kyc.*') ? 'bg-gray-800 text-white' : 'text-gray-300 hover:bg-gray-800' }}">
