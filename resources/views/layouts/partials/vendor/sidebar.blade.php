    ...
    <div class="bg-white px-6 py-5">
        ...
        <div class="pb-2 mt-2 border-b border-gray-100">
            {{--<div class="relative">
                ...
                <input type="text" placeholder="Search" class="w-full rounded-lg pl-11 pr-3 py-2 text-sm bg-gray-100 focus:outline-none"/>
            </div>--}}
        </div>
    </div>
            ...
            >
                ...
                <div x-show="open" x-collapse x-cloak class="space-y-1 pl-3 mt-1">
                    ...
                    <a
                        ...
                        class="block px-6 py-1 text-sm rounded-md transition
                        {{ request()->routeIs('vendor.pos.list') || request()->routeIs('vendor.pos.show')
                            ? 'bg-emerald-50 text-gray-900 border-[#00995c] pl-5 font-semibold'
                            : 'text-gray-600 hover:bg-gray-50 hover:pl-5 border-transparent' }}"
                    >
                        - POS Booking
                    ...
                    <a
                        ...
                        class="block px-6 py-1 text-sm rounded-md transition
                        {{ request()->routeIs('vendor.pos.customers') || request()->routeIs('vendor.pos.customers.show')
                            ? 'bg-emerald-50 text-gray-900 border-[#00995c] pl-5 font-semibold'
                            : 'text-gray-600 hover:bg-gray-50 hover:pl-5 border-transparent' }}"
                    >
                        - POS Customers
