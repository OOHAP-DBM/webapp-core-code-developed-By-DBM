    ...
    <nav class="px-4 pb-4">
        <div class="space-y-1">
            ...
            <div class="space-y-1">
                ...
                <a href="{{ route('vendor.import.enhanced') }}" class="block ml-9 px-3 py-1.5 text-sm rounded-lg {{ request()->routeIs('vendor.import.enhanced') ? 'bg-emerald-50 text-gray-900 font-semibold' : 'text-gray-600 hover:bg-gray-50' }}">
                    Enhanced Import
                </a>
            </div>
            @endcan
