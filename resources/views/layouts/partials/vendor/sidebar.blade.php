...
>
    ...
    <nav class="px-4 pb-4 flex-1 overflow-y-auto">
        <div class="space-y-1">
            ...
            {{-- My Order --}}
            <a href="{{ route('vendor.pos.list', ['status' => 'confirmed']) }}"
                class="flex items-center px-3 py-2 text-sm font-medium rounded-lg {{ request()->routeIs('vendor.pos.*') && request('status') === 'confirmed' ? 'bg-[#00995c] text-white' : 'text-gray-700 hover:bg-gray-50' }}">
                <span class="sidebar-icon flex items-center justify-center min-w-[24px]">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm-1-13h2v6h-2zm0 8h2v2h-2z" fill="currentColor"/>
                    </svg>
                </span>
                <span class="sb-nav-text ml-3">My Order</span>
            </a>
